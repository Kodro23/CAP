...
logit <- setRefClass(
  ...
  methods = list(
    ...
    fit_logit = function(var,main_var="Grupo", other_variables=NULL) {
    ...
    performance_logit = function(fit, var, main_var="Grupo", other_variables=NULL) {
...
cox <- setRefClass(
  ...
  methods = list(
    ...
    get_cox_results = function(main_var="Grupo", other_variables=NULL) {
